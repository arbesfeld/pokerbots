...
//			}
			...
			System.out.println("3B: " + maj.get3BetRate());
			System.out.println("2B: " + maj.get2BetRate());
			System.out.println("PF3B: " + maj.getPF3BetRate());
			System.out.println("PF2B: " + maj.getPF2BetRate());
			...
			outStream.println("PUT " + maj.oppName + ":PF3B " + maj.getValueToSave("PF3B"));
			outStream.println("PUT " + maj.oppName + ":PF2B " + maj.getValueToSave("PF2B"));
