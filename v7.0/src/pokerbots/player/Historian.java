...
//		double threeBRate = ((double)threeBCount) / Math.max(1, numHandsPlayed-instantFold);
//		return (50*threeB + threeBRate*(numHandsPlayed-instantFold)) / (numHandsPlayed-instantFold + 50);
